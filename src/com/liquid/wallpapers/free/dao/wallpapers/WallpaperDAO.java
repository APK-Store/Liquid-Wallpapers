 ...
 */
package com.liquid.wallpapers.free.dao.wallpapers;
...
public final class WallpaperDAO implements IWallpaperDAO {
	 ...
	 *            Response handler parsing the response
	 * @param maxRetries
	 *            Max count of retries before exception
	 ...
	 */
	@Override
	public Bitmap downloadImage(URI uri) throws ClientProtocolException,
			IOException {
		return this.download(uri, new BitmapHttpResponseHandler(),
	 ...
	 * 
	 * @see
	 * de.dan_nrw.android.scroid.dao.wallpapers.IWallpaperDAO#getAvailableWallpapers
	 * (android.content.Context)
	 */
	@Override
	public Wallpaper[] getAvailableWallpapers(Context context)
			throws WallpaperListReceivingException {
		try {
			String data = this.download(
					URI.create(context.getString(R.string.galleryUrl)),
			...
			throw new WallpaperListReceivingException(
					context.getString(R.string.receivingException), ex);
		} catch (IOException ex) {
			throw new WallpaperListReceivingException(
					context.getString(R.string.receivingException), ex);
		} catch (ParseException ex) {
			throw new WallpaperListReceivingException(
					context.getString(R.string.parseExceptionText), ex);
		}
	}
}