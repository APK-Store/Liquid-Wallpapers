...
public class CommunicationChooseDialog extends Dialog {
	 ...
	 * @param listener
	 */
	public CommunicationChooseDialog(Context context,
			Communication[] communications, CommunicationChosenListener listener) {
		super(context);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		listView.setAdapter(new CommunicationListAdapter(this.communications,
				this.getContext()));
